...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            ...
            'volume_path': '/dev/shm/data/Synapse/test',
            'list_dir': '/dev/shm/data/Synapse/list',
            'num_classes': 9,
            'z_spacing': 1,
        },
    }
    ...
    args.exp = 'LamFormer' + dataset_name + str(args.img_size)
    ...
    net = v3(image_size=args.img_size, num_classes=args.num_classes).to(args.device)
