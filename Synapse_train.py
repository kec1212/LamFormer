...
from networks.LamFormer import lamformer


parser = argparse.ArgumentParser()

parser.add_argument('--train_root_path', type=str,
                    default='/dev/shm/data/Synapse/train', help='train root dir for data')
parser.add_argument('--volume_path', type=str,
                    default='/dev/shm/data/Synapse/test', help='root dir for validation volume data')
parser.add_argument('--dataset', type=str,
                    default='Synapse', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='/dev/shm/data/Synapse/list', help='list dir')
...
if __name__ == "__main__":
    ...
    args.exp = 'LamFormer_' + dataset_name + str(args.img_size)
    ...
    net = lamformer(image_size=args.img_size, in_chans=3, num_classes=args.num_classes).to(args.device)
